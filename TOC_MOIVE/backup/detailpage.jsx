...
// for mock data to handle case when no props is sent
// const MOCK_MOVIE = {
//   id: 1,
...
// Error state when movie not found or error occurs during fetch
...
// In real case, we will fetch movie data from backend using the id param and pass it to this component as props.
...
export default function DetailPage() {
  ...
  // I put this part to fetch movie data from backend.
  useEffect(() => {
    fetch(`${API}/movies/${id}`)
      .then(res => {
...
//I change this part to handle back navigation when movie not found or error occurs. It will go back to previous page instead of home page.
  const handleBack = () => {
      window.history.back();
  };
