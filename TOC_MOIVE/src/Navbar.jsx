    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            <a href="/" style={linkStyle('/')} className="hover:text-white transition-colors">
              Home
            </a>
            <a href="/movies" style={linkStyle('/movies')} className="hover:text-gray-200 transition-colors">
              Movies
            </a>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4" id="navbar-search-area">
          ...
          <a
            ...
            style={{ textDecoration: 'none', color: 'white', width: '161px', height: '42px', justifyContent: 'center', flexShrink: 0 }}
          >
      ...
      {searchOpen && (
        ...
        >
          <input
            ...
            className="placeholder-gray-500"
          />
          <p className="text-gray-600 text-xs mt-1.5 px-1">Press Enter to search</p>
        </div>
      )}
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#1a1a1a] border-b border-gray-800 px-6 py-4 flex flex-col gap-4 sticky top-[68px] z-40 items-center">
          <a href="/" style={linkStyle('/')} className="text-sm hover:text-white transition-colors">
            Home
          </a>
          <a href="/movies" style={linkStyle('/movies')} className="text-sm hover:text-gray-200 transition-colors">
            Movies
          </a>
          <a
            href="https://github.com/Ppunpprem/TOC_movie_website"
